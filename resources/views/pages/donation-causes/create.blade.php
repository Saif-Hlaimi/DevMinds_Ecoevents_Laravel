                                    ...
                                    <div class="form-area">
                                        <form action="{{ route('donation-causes.store') }}" method="POST" enctype="multipart/form-data" novalidate>
                                            ...
                                            <div class="position-relative mb-3">
                                                <i class="fa-solid fa-heading position-absolute" style="left:14px;top:50%;transform:translateY(-50%);color:#6b7280"></i>
                                                <input type="text" name="title" value="{{ old('title') }}" placeholder="Cause Title" required style="padding-left:42px;">
                                            </div>
                                            <div class="position-relative mb-3">
                                                <i class="fa-solid fa-paragraph position-absolute" style="left:14px;top:50%;transform:translateY(-50%);color:#6b7280"></i>
                                                <textarea name="description" placeholder="Cause Description" required style="padding-left:42px; height:150px;"></textarea>
                                            </div>
                                            <div class="position-relative mb-3">
                                                <i class="fa-solid fa-image position-absolute" style="left:14px;top:50%;transform:translateY(-50%);color:#6b7280"></i>
                                                <input type="file" name="image" accept="image/*" style="padding-left:42px;">
                                            </div>
                                            <div class="position-relative mb-3">
                                                <i class="fa-solid fa-dollar-sign position-absolute" style="left:14px;top:50%;transform:translateY(-50%);color:#6b7280"></i>
                                                <input type="number" name="goal_amount" step="0.01" min="0.01" value="{{ old('goal_amount') }}" placeholder="Goal Amount" required style="padding-left:42px;">
                                            </div>
                                            <div class="position-relative mb-3">
                                                <i class="fa-solid fa-globe position-absolute" style="left:14px;top:50%;transform:translateY(-50%);color:#6b7280"></i>
                                                <input type="text" name="sdg" value="{{ old('sdg') }}" placeholder="Sustainable Development Goal (e.g., SDG1)" required style="padding-left:42px;">
                                            </div>

                        ...
                        <div class="row g-0 auth-card overflow-hidden">
                            ...
                            <div class="col-lg-6 bg-white" style="border-radius: 0 18px 18px 0;">
                                <div class="p-4 p-md-5">
                                    ...
                                    <p class="text-muted mb-30">Enter your email and new password to reset your account.</p>
                                    <div class="form-area">
                                        <form action="{{ route('password.update') }}" method="POST" novalidate>
                                            ...
                                            <div class="position-relative mb-3">
                                                ...
                                                <input type="email" name="email" value="{{ old('email', $email) }}" placeholder="Email address" required style="padding-left:42px;">
                                            </div>
                                            <div class="position-relative mb-3">
                                                <i class="fa-solid fa-lock position-absolute" style="left:14px;top:50%;transform:translateY(-50%);color:#6b7280"></i>
                                                <input type="password" name="password" placeholder="New Password" required style="padding-left:42px;">
                                            </div>
                                            <div class="position-relative mb-3">
                                                <i class="fa-solid fa-lock position-absolute" style="left:14px;top:50%;transform:translateY(-50%);color:#6b7280"></i>
                                                <input type="password" name="password_confirmation" placeholder="Confirm Password" required style="padding-left:42px;">
                                            </div>
                                            <button class="auth-btn w-100 mt-2" type="submit">Reset Password</button>
                                        </form>

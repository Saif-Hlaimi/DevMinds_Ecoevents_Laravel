          ...
          <div class="row g-0 auth-card overflow-hidden" style="position: relative; z-index: 2;">
            ...
            <div class="col-lg-6 d-none d-lg-block">
              <div class="h-100 w-100"
                   style="background: url('https://images.unsplash.com/photo-1469474968028-56623f02e42e?q=80&w=1200&auto=format&fit=crop') center/cover no-repeat; min-height:380px;">
              </div>
            </div>

            <!-- Colonne formulaire -->
            <div class="col-lg-6 bg-white" style="border-radius: 0 18px 18px 0; position: relative; z-index: 10;">
              <div class="p-4 p-md-5">
                ...
                <form action="{{ route('login.attempt') }}" method="POST" novalidate>
                  ...
                  <div class="position-relative mb-3">
                    ...
                    <input type="email" name="email" value="{{ old('email') }}" placeholder="Email address" required class="form-control ps-5">
                  </div>
                ...
                <!-- OAuth -->
                <div class="login__with auth-oauth mt-3">
